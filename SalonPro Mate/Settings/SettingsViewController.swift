...
class SettingsViewController: UIViewController ,UIImagePickerControllerDelegate, UINavigationControllerDelegate, UITextFieldDelegate{
    ...
    override func viewDidLoad() {
        ...
        settingList = ["Home","DiseWise","Clear All Things","Feedback","About Us","Share the App","Privacy Notice"]
    ...
    private func NavToWelcome() {
        ...
        let newViewController = storyBoard.instantiateViewController(withIdentifier: "StartViewViewController") as! StartViewViewController
...
extension SettingsViewController: UITableViewDelegate, UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if indexPath.item == 0 {
           ...
           let appID = "SalonProMate" // Replace with your actual App ID
