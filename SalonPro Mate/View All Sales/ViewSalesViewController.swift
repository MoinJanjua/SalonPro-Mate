...
class ViewSalesViewController: UIViewController {
    ...
    var currency = String()
    var Booking_Detail: [Ordered] = []
    var filteredOrderDetails: [Ordered] = []  // Filtered data to display in the table view
    ...
    func filterTransactions() {
        ...
        // Filter the orders directly using the Date comparison
